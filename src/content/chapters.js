    ...
    deeper: [
      {
        ...
        note: 'The resources, the CLI, and Flux, as the stack repository describes them.',
        owner: 'cli',
      },
      {
        source: 'designs',
        kicker: 'Azure/osdu-spi-stack',
        title: 'Design guides',
        note: 'How each part of the stack is meant to be built and operated.',
        owner: 'cli',
      },
      {
        source: 'decisions',
        ...
        note: 'Every architecture decision record, with the trade-offs behind the stack.',
        owner: 'cli',
      },
      {
        source: 'engineering',
        ...
        note: 'The template’s branches, workflows, and cascade, from its own documentation.',
        owner: 'you',
      },
      {
        ...
        note: 'The Community Implementation the lessons compare against.',
        owner: 'fork',
      },
      {
        ...
        note: 'The upstream PartitionServiceImpl the Azure provider sits beside.',
        owner: 'fork',
      },
    ],
  },
