...
- Every learn view answers one stated question, names what it builds on, says in one sentence which levels of the zoom ladder it works at, and ends with two or three things the learner can now say. Position on the ladder is stated in prose, not as a control: a chip strip was tried and read as navigation. New content must fit a level; if it does not, the ladder is wrong or the content belongs in a supplement.
