...
- The start page carries the frame at three depths: a one-minute video in its own element (poster, captions, source checks under it; it pauses the dock and the dock pauses it), the two-minute brief as the page's cue, and a link to the full orientation. The video is not an episode and has no markers; keep it to the start page.
