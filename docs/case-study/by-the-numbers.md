...
| --------------------------------------------- | ---------------------------- | ----------- |
| First session opened                          | Fri 11 Sep 17:10             | Transcripts |
| First commit                                  | Fri 11 Sep 17:29             | Git         |
| Last commit of the build                      | Mon 14 Sep 11:36             | Git         |
| Calendar days with commits                    | 4                            | Git         |
| Hours with a commit on Sunday                 | 12 of 12 from 11:00 to 23:00 | Git         |
...
| Commits in the two hours 14:00 to 16:00 Sunday                      | 67                                                                                                              | Git            |
...
| Ten largest commits                                                 | all on Friday and Saturday; four are successive orientation-episode replacements within three hours on Saturday | Git            |
...
| Codex as implementer                                                      | the five-file prototype, the source layout and first review response (11 Sep, before the first Claude session), and the lesson 01 rebuild (13 Sep); 710 responses across 7 tasks, 138 at medium effort and 572 at xhigh | Codex task ledger                 |
...
The full breakdown by channel, model, role, and day, with the accounting rules, is in [usage/README.md](usage/README.md). The cutoff for every cross-channel figure is the Pages run for `62be86e`, 14 September 11:41 CDT.
...
| Runs in parallel at the Sunday peak                             | 3                                                                                                                                                             | Keelson                 |
...
| Numbered revisions               | 23 (revisions 1 to 3 on 12 to 13 Sep; 4 to 14 on Sun 13 Sep; 15 to 23 on Mon 14 Sep) | The artifact's changelog |
