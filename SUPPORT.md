...
[existing issues](https://github.com/danielscholl-osdu/osdu-spi-training/issues) before filing new issues
to avoid duplicates. For new issues, file your bug or feature request as a
[new Issue](https://github.com/danielscholl-osdu/osdu-spi-training/issues/new).
...
Support for this training site is limited to the resources listed above.
